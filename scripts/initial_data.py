...
event_1=Event(group=group_1, event_name="Prototyping for Success, Power and Unlimited Riches", created=datetime.datetime(2013, 11, 1, 1, 2, 3, tzinfo=None), ended=datetime.datetime(2013, 11, 2, 1, 2, 3, tzinfo=None), location="Chicago", status=True,
...
event_2=Event(group=group_1, event_name="A powerfully simple way to monitor your Web & Mobile applications", created=datetime.datetime(2013, 11, 8, 1, 2, 3, tzinfo=None), ended=datetime.datetime(2013, 11, 12, 1, 2, 3, tzinfo=None), location="Chicago", status=True,
...
event_3=Event(group=group_1, event_name="Our Grads Speak Multiple Languages: HTML5, iOS & ROI", created=datetime.datetime(2013, 11, 20, 1, 2, 3, tzinfo=None), ended=datetime.datetime(2014, 11, 25, 1, 2, 3, tzinfo=None), location="Chicago", status=True,
...
event_4=Event(group=group_2, event_name="TechNet Webcast: Successfully Deploy Project Server on VMware with Shared Infrastructure", ended=datetime.datetime(2013, 11, 2, 1, 2, 3, tzinfo=None), created=datetime.datetime(2012, 12, 20, 1, 2, 3, tzinfo=None),status=False,
...
event_5=Event(group=group_2, event_name="This Is Microsoft Dynamics GP", created=datetime.datetime(2013, 4, 3, 1, 2, 3, tzinfo=None), ended=datetime.datetime(2013, 5, 2, 1, 2, 3, tzinfo=None), status=False,
...
event_5=Event(group=group_2, event_name="Visual Studio Team System Lab Management ", created=datetime.datetime(2013, 11, 12, 1, 2, 3, tzinfo=None), ended=datetime.datetime(2013, 11, 20, 1, 2, 3, tzinfo=None), location="Chicago", status=True,
...
event_6=Event(group=group_3, event_name="Feel your freedom", created=datetime.datetime(2013, 5, 20, 1, 2, 3, tzinfo=None), ended=datetime.datetime(2013, 6, 2, 1, 2, 3, tzinfo=None), status=False,
...
event_7=Event(group=group_4, event_name="Culinary training Celebrity Chef Paul Virant to deliver keynote address at Colorado Culinary Academy inaugural graduation ceremony! ", created=datetime.datetime(2013, 5, 20, 1, 2, 3, tzinfo=None), ended=datetime.datetime(2013, 10, 2, 1, 2, 3, tzinfo=None), location="Chicago", status=True,
...
event_8=Event(group=group_4, event_name="Edinburgh International Conference ", created=datetime.datetime(2013, 9, 24, 1, 2, 3, tzinfo=None), ended=datetime.datetime(2013, 10, 2, 1, 2, 3, tzinfo=None), status=False,
...
event_9=Event(group=group_5, event_name="Soccer Business", created=datetime.datetime(2013, 10, 14, 1, 2, 3, tzinfo=None), ended=datetime.datetime(2013, 10, 20, 1, 2, 3, tzinfo=None), location="Chicago", status=True,
