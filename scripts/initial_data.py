...
uskill_12.save()
uskill_13 = UserSkill(user=user_6, skill=skill_3, scale=3)
uskill_13.save()
uskill_14 = UserSkill(user=user_6, skill=skill_2, scale=8)
uskill_14.save()
uskill_15 = UserSkill(user=user_7, skill=skill_3, scale=4)
uskill_15.save()
uskill_16 = UserSkill(user=user_7, skill=skill_2, scale=6)
uskill_16.save()
uskill_17 = UserSkill(user=user_8, skill=skill_3, scale=2)
uskill_17.save()
uskill_18 = UserSkill(user=user_8, skill=skill_4, scale=7)
uskill_18.save()
